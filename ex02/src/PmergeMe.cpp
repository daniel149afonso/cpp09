...
/*   Updated: 2026/05/11 18:02:04 by daafonso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// display time
template <typename T>
static void display_time(double start, double end,
...
int mergeSort(char **argv, int argc) {
	...
	double start_vector = getTimeUs();
	mergeInsertSort(v);
	double end_vector = getTimeUs();

	// Sort Deque
	double start_deque = getTimeUs();
	mergeInsertSort(d);
	double end_deque = getTimeUs();
